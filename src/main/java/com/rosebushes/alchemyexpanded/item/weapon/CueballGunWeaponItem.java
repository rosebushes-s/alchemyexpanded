...
public class CueballGunWeaponItem extends GunWeaponItem {
    ...
    public CueballGunWeaponItem(Properties properties, double speed, float spread, int rate, int reload) {
        super(properties, 0, speed, 1, spread, rate, 1, 1, reload, false, false, MSItems.CUEBALL.get(), null);
    }

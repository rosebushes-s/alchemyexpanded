...
public class AEItems {
    ...
    static {
        ...
        WISE_GUY_SLIME_SUIT_CHEST = REGISTER.register("wise_guy_slime_suit_chest", () -> new AEArmorItem(AEItemTypes.WISE_GUY_SLIME_SUIT_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
        WISE_GUY_SLIME_SUIT_PANTS = REGISTER.register("wise_guy_slime_suit_pants", () -> new AEArmorItem(AEItemTypes.WISE_GUY_SLIME_SUIT_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Properties()));
